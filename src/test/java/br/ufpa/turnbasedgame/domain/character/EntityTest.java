...
class EntityTest {
    ...
    private static class ConcreteEntity extends Entity {
        public ConcreteEntity(String name, int hitPoints, int attackPower, int defense, int dexterity, int speed) {
    ...
    // Cria uma instância da nossa entidade de teste antes de cada teste, para cada teste ser independente.
    @BeforeEach
    void setUp() {
    ...
    void testReceiveDamage_BlockedByDefense() {
        ...
        assertEquals(100, character.getHitPoints(), "HP não deve mudar se o dano for totalmente defendido");
    }
